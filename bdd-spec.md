...
{ i: 22,
  ...
  depth: 0,
  depthLimit: Infinity,
  ancestors: [ { bin: 'af461e0a' }, 'af461e0a' ],
  ancestorKeys: [ 'bin' ],
  ancestorInstanceOf: [ 'bin16' ],
  ancestorTags: [],
  classes: {},
  tags: {},
  meta: undefined }
{ i: 76,
  ...
  depthLimit: Infinity,
  ancestors: 
   [ { bin: <Buffer af 46 1e 0a>,
       date1: 'Fri Jan 02 1970 11:17:36 GMT+0100 (CET)' },
     'Fri Jan 02 1970 11:17:36 GMT+0100 (CET)' ],
  ancestorKeys: [ 'date1' ],
  ancestorInstanceOf: [ 'date' ],
  ancestorTags: [],
  classes: {},
  tags: {},
  meta: undefined }
...
{ i: 178,
  ...
  ancestors: 
   [ { bin: <Buffer af 46 1e 0a>,
       ...
       array: [Object] },
     [ [Object] ],
     [ Fri Jan 02 1970 11:17:36 GMT+0100 (CET), '/abc/gi' ],
     '/abc/gi' ],
  ancestorKeys: [ 'array', 0, 1 ],
  ancestorInstanceOf: [ , , 'regex' ],
  ancestorTags: [ ,  ],
  classes: {},
  tags: {},
...
{ i: 313,
  ...
  ancestors: 
   [ { bin: <Buffer af 46 1e 0a>,
       ...
       array: [Object],
       object: [Object] },
     { date2: 'Fri Jan 02 1970 11:17:36 GMT+0100 (CET)' },
     'Fri Jan 02 1970 11:17:36 GMT+0100 (CET)' ],
  ancestorKeys: [ 'object', 'date2' ],
  ancestorInstanceOf: [ , 'date' ],
  ancestorTags: [  ],
  classes: {},
  tags: {},
...
{ i: 15,
  ...
  depth: -1,
  depthLimit: Infinity,
  ancestors: [ { tpl: undefined }, undefined ],
  ancestorKeys: [ 'tpl' ],
  ancestorInstanceOf: [ 'Template' ],
  ancestorTags: [],
  classes: {},
  tags: {},
  meta: undefined }
...
{ i: 30,
  ...
  depth: 0,
  depthLimit: Infinity,
  ancestors: [ { a: 1234, bin: 'fd104b19' }, 'fd104b19' ],
  ancestorKeys: [ 'bin' ],
  ancestorInstanceOf: [ 'bin16' ],
  ancestorTags: [],
  classes: {},
...
{ i: 87,
  ...
  ancestors: 
   [ { a: 1234,
       bin: <Buffer fd 10 4b 19>,
       date1: 'Fri Apr 29 2016 12:08:14 GMT+0200 (CEST)' },
     'Fri Apr 29 2016 12:08:14 GMT+0200 (CEST)' ],
  ancestorKeys: [ 'date1' ],
  ancestorInstanceOf: [ 'Date' ],
  ancestorTags: [],
  classes: {},
...
{ i: 145,
  ...
  ancestors: 
   [ { a: 1234,
       bin: <Buffer fd 10 4b 19>,
       date1: Fri Apr 29 2016 12:08:14 GMT+0200 (CEST),
       date2: Fri Apr 29 2016 12:08:08 GMT+0200 (CEST),
       b: 'toto',
       regex1: '/abc/' },
     '/abc/' ],
  ancestorKeys: [ 'regex1' ],
...
{ i: 202,
  ...
  ancestors: 
   [ { a: 1234,
       ...
       sub: [Object] },
     { sub: [Object] },
     { date3: Thu Jan 01 1970 01:00:01 GMT+0100 (CET),
       regex2: '/abc/m' },
     '/abc/m' ],
  ancestorKeys: [ 'sub', 'sub', 'regex2' ],
  ancestorInstanceOf: [ , , 'regex' ],
  ancestorTags: [ ,  ],
  classes: {},
  tags: {},
...
{ i: 258,
  ...
  ancestors: 
   [ { a: 1234,
       ...
       sub: [Object],
       d: 2,
       json: '{"a":1,"b":2,"array":[1,2,"three"]}' },
     '{"a":1,"b":2,"array":[1,2,"three"]}' ],
  ancestorKeys: [ 'json' ],
  ancestorInstanceOf: [ 'JSON' ],
  ancestorTags: [],
  classes: {},
  tags: {},
  meta: undefined }
{ i: 23,
  ...
  depth: 0,
  depthLimit: Infinity,
  ancestors: [ { simple: 'abc' }, 'abc' ],
  ancestorKeys: [ 'simple' ],
  ancestorInstanceOf: [ 'simple' ],
  ancestorTags: [],
  classes: { simple: [Function: Simple], complex: [Function: Complex] },
  tags: {},
  meta: undefined }
{ i: 63,
  iStartOfLine: 64,
  ...
  ancestors: 
   [ { simple: [Object], complex: [Object] },
     { str: 'hello', int: 6 },
     6 ],
  ancestorKeys: [ 'complex', 'int' ],
  ancestorInstanceOf: [ 'complex' ],
  ancestorTags: [  ],
  classes: { simple: [Function: Simple], complex: [Function: Complex] },
  tags: {},
  meta: undefined }
